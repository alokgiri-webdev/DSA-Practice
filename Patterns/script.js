...
//Patterns to solve for Practice
/*
1. For example if N = 5 then pattern will be like:
...
/*
2. For example if N = 5 then pattern will be like:
...
/*
3. For example if N = 5 then pattern will be like:
...
/*
4. For example if N = 5 then pattern will be like:
